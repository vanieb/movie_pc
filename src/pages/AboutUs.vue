<template>
  <v-container>
    <v-layout>
      <div align="justify" class="white--text" style="font-style: SourceHanSansCN-Regular !important;">
        ...
        <p style="text-indent: 30pt;">
          ...
          Rogers releasing Corporation is still now one of the most
          transformative company in the film industry.
        </p>
      </div>
    </v-layout>
    <br />
    <v-row>
      <v-col cols="6" sm="3" v-for="i in images" :key="i">
  ...
  data() {
    return {
      images: [
        ...
        {
          id: 4,
          name: "Irrfan Khan of Life of Pi (2012)",
        },
      ],
    };
  },
